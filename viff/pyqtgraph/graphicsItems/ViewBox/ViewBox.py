...
class ViewBox(GraphicsWidget):
    ...
    * Item coordinate mapping methods
    ...
    def useMyMenu(self, switch=0):
        if switch == 0:
            self.menu = MyViewBoxMenu(self)
        else:
            self.menu = MyViewBoxMenu2(self)
...
from .MyViewBoxMenu import MyViewBoxMenu
from .MyViewBoxMenu2 import MyViewBoxMenu2
