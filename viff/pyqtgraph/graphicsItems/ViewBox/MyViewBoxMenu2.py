...
class MyViewBoxMenu2(QtGui.QMenu):

    sigPopout = QtCore.Signal()
    ...
    def __init__(self, view):
        ...
        # self.popout = QtGui.QAction("View slice in new window", self)
        # self.popout.triggered.connect(self.popoutWindow)
        # self.addAction(self.popout)
