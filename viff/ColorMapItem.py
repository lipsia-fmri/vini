...
Gradients = OrderedDict([
    ...
    ('positive_vlv', {'ticks': [(0.0, (0, 0, 255, 255)), (0.25, (127, 255, 255, 255)), (0.5, (255, 255, 255, 255)), (0.75, (255, 255, 127, 255)), (1.0, (255, 0, 0, 255))], 'mode': 'rgb'}),
    ...
    def restoreState(self, state):
        ...
        **Arguments:**
        state           A dictionary with same structure as those returned by
                        :func:`saveState <pyqtgraph.ColorMapItem.saveState>`
